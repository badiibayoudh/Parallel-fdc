...
set "XML_INPUT_DIRECTORY=C:\git\Parallel-fdc\windows\configsPrd\"
set "FILE_DOWNLOAD_CLIENT_HOME=C:\git\Parallel-fdc\windows\"
set "Log_OUTPUT=C:\git\Parallel-fdc\windows\logs\"
REM set "maxProc=28"
set "maxProc=7"
